...
namespace tti_graduation_work.Application.Users.Queries.Sync
{

	public class SyncQuery : IRequest
	{
	}

	public class SyncQueryHandler : IRequestHandler<SyncQuery>
	{
		private readonly IApplicationDbContext context;

		public SyncQueryHandler(IApplicationDbContext context)
		{
			this.context = context;
		}

		public async Task<Unit> Handle(SyncQuery message, CancellationToken cancellationToken)
		{
